        		...
        		<div class="row welcome_inner">
        			<div class="col-lg-6">
        				<div class="welcome_text">
        					<h4>About Myself</h4>
        					<p><strong>A Passionate Learner || Dreamer || Achiever</strong><br>A Computer web developer, system administrator Undergrad Student at learninglions. A Tech-Enthusiast with quick learning skills. Love to explore the world and new things around. Apart from Technical side, a Friendly person who loves to meet new people. A Music-lover and Writer.   </p>
        					<div class="row">
        						<div class="col-md-4">
        							<div class="wel_item">
        			...
        			<div class="col-lg-6">
        				<div class="tools_expert">
        					<div class="skill_main">
								...
								<div class="skill_item">
									<h4>Front-end Development <span class="counter">90</span>%</h4>
									<div class="progress_br">
										<div class="progress">
								...
								<div class="skill_item">
									<h4>Backend  <span class="counter">95</span>%</h4>
									<div class="progress_br">
										<div class="progress">
								...
								<div class="skill_item">
									<h4>UI/UX Design<span class="counter">97</span>%</h4>
									<div class="progress_br">
										<div class="progress">
